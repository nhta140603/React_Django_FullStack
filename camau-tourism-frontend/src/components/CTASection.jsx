      ...
      <div className="container mx-auto px-6 relative z-10">
        <MotionItem direction="right" x={30}>
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 drop-shadow-sm">Sẵn Sàng Cho Chuyến Đi Tiếp Theo?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/lien-he" 
                className="bg-white text-yellow-500 hover:bg-gray-100 font-bold px-8 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Liên hệ ngay
              </Link>
              <Link 
                to="/danh-sach-chuyen-du-lich" 
                className="bg-transparent hover:bg-white/20 text-white border-2 border-white/80 font-bold px-8 py-4 rounded-full transition-all duration-300"
              >
                Xem các tour
              </Link>
            </div>
