      ...
      <div className="container mx-auto px-6 relative z-10">
        <MotionItem direction="left" x={30}>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-6">Tạo Hành Trình Cá Nhân Của Bạn</h2>
            ...
            >
              ...
              <button className="relative bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold px-8 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-blue-500/30">
