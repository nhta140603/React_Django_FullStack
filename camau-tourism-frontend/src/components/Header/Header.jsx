        ...
        <div className="header-bar flex lg:hidden justify-between items-center px-3 py-2 relative">
          ...
          <div className="flex items-center gap-2">
            <div className="relative" ref={mobileNotificationsRef}>
              <button
                className="p-2 rounded-full text-white bg-blue-500/80 hover:bg-blue-700 transition relative"
                onClick={() => user && setMobileNotificationsOpen((prev) => !prev)}
              ...
              {user && mobileNotificationsOpen && (
                <div className="absolute right-0 mt-1 w-80 bg-white text-gray-800 shadow-xl rounded-xl py-1 z-50 dropdown-menu origin-top-right">
                      ...
                      notifications.map((notification) => (
                        <div
                          ...
                          className={classNames(
                            "flex items-start gap-3 px-4 py-3 hover:bg-blue-50 transition-colors cursor-pointer",
