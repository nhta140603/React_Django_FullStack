    ...
    <header className={classNames(
      ...
      <div
        className={classNames(
          "fixed inset-0 bg-blue-500 z-40 lg:hidden flex flex-col transition-all duration-300 ease-in-out backdrop-blur-lg",
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center flex-grow bg-gradient-to-b from-blue-500 to-blue-200 p-4 shadow-lg">
          <ul className="flex flex-col space-y-6 text-center w-full h-full px-12">
            {menuItems.map((item, index) => (
