        ...
        {skeletonPairs.map(pairIdx => (
          <div key={pairIdx} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[0, 1].map(idx => (
              <div
                key={idx}
                className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-gray-100 to-gray-200 animate-pulse"
              >
                <div className="flex flex-col md:flex-row">
                  <div className="relative md:w-2/5 h-52 bg-gray-300 rounded-l-2xl overflow-hidden">
                    <div className="absolute top-4 left-4 h-6 w-20 bg-yellow-200 rounded-full"></div>
                  </div>
                  <div className="relative flex flex-col p-6 md:w-3/5 space-y-3">
